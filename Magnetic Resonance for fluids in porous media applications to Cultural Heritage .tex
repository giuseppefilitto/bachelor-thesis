...
A radio-frequency pulse consists in the application of an oscillating magnetic field $B_1$ perpendicular to the $B_0$, for a certain interval of time, in order to move the net magnetization of the system from the equilibrium condition. Depending on the application time and the intensity of the $B_1$, the pulse can flip the magnetization vector by a certain angle (flip or nutation angle). The most common pulses that characterize the pulse sequences, in order to measure $T_1$ and $T_2$ time constants, are the $\pi/2$-pulse and $\pi$-pulse.\\ The acquired signal is the FID (Free Induction Decay) whose duration is limited by the $T_2$ relaxation and due to the inhomogeneity of the local fields it presents a more rapid signal damping. Moreover, sometimes the effect of diffusion must be accounted for. To resolve this issues and in order to measure the correct decaying for the relaxation times, there are several Pulse Sequences. The most used are Spin-Echo, CPMG and Saturation Recovery. 
	...
	\subsubsection{Spin-Echo} \label{spinecho}
	 The Spin-Echo sequence consists in a first $\pi/2$ pulse followed by a second $\pi$-pulse applied after a certain interval of time called Echo-Time($T_E$). The $\pi$ pulse, produces an echo due to the re-phasing of the spins. The echo envelope give us the correct exponential $T_2$ relaxation process. In fact the exponential relaxation $T_{2}^*$ measured on the FID would have been shorter.\\ The decay of the magnetization is given by the equation:
         ...
         \begin{figure}[h]
      	\centering
      	\includegraphics[width=0.45\linewidth]{figures/Spin2}
      ...
      \begin{figure}[h]
      	\centering
      	\includegraphics[width=0.4\linewidth]{figures/CPMG}
...
\begin{figure}[h]
      	\centering
      	\includegraphics[width=0.4\linewidth]{figures/Saturationrecovery}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\linewidth]{figures/depthprofile3}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.8\linewidth]{figures/kspace}
...
\begin{figure}[h]
      	\centering
      	\includegraphics[width=0.9\linewidth]{figures/mousepm10}
...
\includegraphics[width=0.89\linewidth, height=6cm]{figures/MagnetsNMRMOUSE} 
\caption{sketch of NMR-MOUSE sensor}\label{magnets}
\end{subfigure}
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=0.9\linewidth, height=6cm]{figures/ProfileNMRMOUSE}
...
\begin{figure}[h]
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=0.89\linewidth, height=6cm]{figures/Artoscan} 
\caption{}
\label{fig:subim1}
\end{subfigure}
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=0.9\linewidth, height=6cm]{figures/jeol}
\caption{}
\label{fig:subim2}
\end{subfigure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\linewidth]{figures/StoneMRI1}
...
\begin{figure}[h] 
\centering
\includegraphics[width=0.7\linewidth]{figures/StoneMRI2}	
...
\centering
\includegraphics[width=0.8\linewidth]{figures/relaxometry-MIP}
...
\centering
\includegraphics[width=0.7\linewidth]{figures/relaxationmapcolori1}
...
\begin{figure}[h] 
\centering
\includegraphics[width=0.5\linewidth]{figures/Cryptoporticus}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\linewidth]{figures/Moisturemap1}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\linewidth]{figures/moisturemap2}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\textwidth]{figures/villapalagione}
...
\begin{figure}[h]
	\begin{subfigure}{0.5\textwidth}
\includegraphics[width=\columnwidth]{figures/madonna1} 
\caption{}
\end{subfigure}
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=\columnwidth]{figures/madonna2}
\caption{}
\end{subfigure}
...
Many conservation treatments involve exposing paintings to moisture for varying periods of time. In order to control the potential risk during these treatments and to better understand the interaction between the components of the paint and the environmental humidity, there are many experimental techniques that make possible to understand and quantify the distribution of humidity under different conditions in each layer. Both nuclear magnetic resonance and X-ray radiography are among the most used techniques to monitor the level of moisture in cultural heritage artifacts. While X-ray radiography is not very sensitive and is mainly useful for measuring capillary absorption and high volumetric moisture content, NMR is more sensitive due to the ability to detect the signal of $^1H$ water nuclei. Moreover Single-Side NMR devices allow one to perform depth profiles of the paint, in order to better understand the behavior of each layer - in particular the moisture uptake since the medium is porous - when exposed to high humidity conditions.\\
  ...
  \begin{figure}[h]
  	\centering
  	\includegraphics[width=0.9\linewidth]{figures/dueprofilimouse}	
...
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=\columnwidth,, height= 0.8\textwidth]{figures/PEG} 
\caption{}

\end{subfigure}
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=\columnwidth, height= 0.8\textwidth]{figures/68h}
\caption{}
...
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=\columnwidth,, height= 0.8\textwidth]{figures/adorazionemagi} 
\caption{}

\end{subfigure}
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=\columnwidth, height= 0.8\textwidth]{figures/depthprofile}
\caption{}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\columnwidth]{figures/solvents}
...
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=0.9\textwidth, height= 0.9\textwidth]{figures/freewater} 


\end{subfigure}
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=\columnwidth, height= 0.9\textwidth]{figures/boundwater}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.99\textwidth]{figures/sarcofago}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.5\linewidth, height=0.35\linewidth]{figures/wood1}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\textwidth]{figures/parchment}
...
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=\columnwidth, height= 0.8\textwidth]{figures/standardrela} 
\caption{Standard relaxometer}

\end{subfigure}
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=\columnwidth, height= 0.8\textwidth]{figures/singlesidedrela}
...
\
\includegraphics[width=0.9\linewidth, height=6cm]{figures/irpaper} 
\caption{Fit of the IR results}
\end{subfigure}
\begin{subfigure}{0.6\textwidth}
\includegraphics[width=0.99\linewidth, height=6cm]{figures/cpmgpaper}
